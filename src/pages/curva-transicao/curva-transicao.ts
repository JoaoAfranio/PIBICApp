...
export class CurvaTransicaoPage {
  ...
  calcularfCurvaSimples(){
    if (this.visibilidadeQualidade == "Recomendada"){
	
      if (this.velDiretriz == 70){
        this.fCurvaSimples = 0.32;	
      }
      if (this.velDiretriz == 30){
        this.fCurvaSimples = 0.4;	
      }
      if (this.velDiretriz == 40){
        this.fCurvaSimples = 0.38;	
      }
      if (this.velDiretriz == 50){
        this.fCurvaSimples = 0.36;	
      }
      if (this.velDiretriz == 60){
        this.fCurvaSimples = 0.34;	
      }
      if (this.velDiretriz == 80){
        this.fCurvaSimples = 0.31;	
      }
      if (this.velDiretriz == 90){
        this.fCurvaSimples = 0.3;	
      }
      if (this.velDiretriz == 100){
        this.fCurvaSimples = 0.3;	
      }
      if (this.velDiretriz == 120){
        this.fCurvaSimples = 0.28;	
      }
    }else{
      if (this.velDiretriz == 70){
        this.fCurvaSimples = 0.31;	
      ...
      if (this.velDiretriz == 40){
        this.fCurvaSimples = 0.37;	
      }
      if (this.velDiretriz == 50){
        this.fCurvaSimples = 0.35;	
      }
      if (this.velDiretriz == 60){
        this.fCurvaSimples = 0.33;	
      }
      if (this.velDiretriz == 80){
        this.fCurvaSimples = 0.3;	
      }
      if (this.velDiretriz == 90){
        this.fCurvaSimples = 0.29;	
      }
      if (this.velDiretriz == 100){
        this.fCurvaSimples = 0.28;	
      }
      if (this.velDiretriz == 120){
        this.fCurvaSimples = 0.25;	
      }
    }
  }
  ...
  calculoDistanciaParada(){
    if (this.visibilidadeQualidade == "Recomendada"){
      if (this.tipoInclinacao == "Descendente") {
        this.distParada = (0.7 * this.velMedia) + ((this.velMedia * this.velMedia) / (255 * (((this.inclinacao / 100) * -1) + this.fCurvaSimples)));
      }else{
        this.distParada = (0.7 * this.velMedia) + ((this.velMedia * this.velMedia) / (255 * ((this.inclinacao / 100) + this.fCurvaSimples)));
      }
    
    }else{
      if (this.tipoInclinacao == "Descendente") {
        this.distParada = (0.7 * this.velDiretriz) + ((this.velDiretriz * this.velDiretriz) / (255 * (((this.inclinacao / 100) * -1) + this.fCurvaSimples)));
      }else{
        this.distParada = (0.7 * this.velDiretriz) + ((this.velDiretriz * this.velDiretriz) / (255 * ((this.inclinacao / 100) + this.fCurvaSimples)));
      }	
    }
  }
  ...
  calculoAfastamentoHorizontalMinCurva(){
    this.afastamentoHorizontalMinCurva = ((this.distParada * this.distParada) / (8 * this.INPUTraio));
  }
  ...
  transferePagina(){
    ...
    this.navCtrl.push(ParamProjetoCtPage, {
      ...
      fCurvaSimples: this.fCurvaSimples,
